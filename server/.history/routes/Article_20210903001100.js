...
// creating an article
router.post("/",multipleUpload,requireLoginUser,(req,res)=>{
    ...
    const article = new Article ({
        title:title,
        desc:desc,
        img:req.files.image[0].originalname,
        pdf:req.files.file[0].originalname
...
router.put ("/:id",requireLoginUser, async(req,res)=>{
...
router.delete("/:id",requireLoginUser,async (req,res)=>{
