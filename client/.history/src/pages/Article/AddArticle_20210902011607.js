...
function Form() {
  ...
  return (
   ...
   <Paper style={{backgroundColor:"rgba(255,255,255,.85)"}}  className ={classes.paper}>
       <div autoComplete="off"  className={classes.form}>
           <Typography style={{marginBottom:"30px",fontFamily:"font-family: 'Poppins', sans-serif;",fontSize:"40px"}} variant="h6"> Creating a new Article </Typography>
