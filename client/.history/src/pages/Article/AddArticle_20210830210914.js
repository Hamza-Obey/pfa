   ...
   <Paper className ={classes.paper}>
       <div autoComplete="off"  className={classes.form}>
           <Typography style={{marginBottom:"30px",fontFamily:"revert",fontSize:"40px"}} variant="h6"> Creating a new Article </Typography>
            ...
            <TextField style={{marginBottom:"10px"}} name ="title" variant="outlined" label="Title" fullWidth value={title}   />
            ...
            <div className={classes.fileInput}>
                <FileBase onChange={(e)=>setFirst_name(e.target.value)} type="file" multiple={false} />
            </div>
