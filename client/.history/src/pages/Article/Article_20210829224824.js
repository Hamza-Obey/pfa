...
function Article() {
  return (
    <>
    <div class="container7" id="Article">
        <div class="grid7">
            <div class="card7">
                <div class="card_img7">
                ...
                <div class="card_body7">
                    <h2 class="card_title7">Get yourself motivated</h2>
            ...
            <div class="card7">
                ...
                <div class="card_body7">
                    <h2 class="card_title7">Learn the art of cooking</h2>
            ...
            <div class="card7">
                ...
                <div class="card_body7">
                    <h2 class="card_title7">Get your freedom</h2>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid optio quidem, est labore earum reprehenderit quibusdam id iure delectus nemo.</p>
                    <a href="#" class="read_more">Read article</a>
                </div>
            </div>
