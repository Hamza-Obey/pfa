  ...
  useEffect(() => {
    const fetchData1 = async () => {
      const response = await axios
        .get("http://localhost:3002/Personal/Userdata", {
          headers: {
    ...
    const fetchData2 = async () => {
      const response = await axios
        .get("http://localhost:3002/Personal/Count", {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("jwt"),
          },
        })
      ...
      <div className="container">
        <div className="row profile">
          <div className="col-md-3">
            ...
            >
              ...
              <div className="profile-usermenu">
                <ol className="nav">
                  <li>Speciality : {data1.speciality}</li>
                  <li>Birthday : {data1.birthday}</li>
                  <li>Phone Number : {data1.phone}</li>
                  <li>E-mail : {data1.email}</li>
                </ol>
              </div>
          ...
          <div style={{ marginTop: "-40px" }} className="col-md-9">
            <Index3 count={count} setCount={setCount} />
          </div>
        </div>
      </div>
    </>
