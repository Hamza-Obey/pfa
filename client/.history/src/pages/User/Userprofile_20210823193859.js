...
<div className="container">
    <div  className="row profile">
		<div className="col-md-3">
			<div style={{height:"100vh ",backgroundColor:"#ddd"}} className="profile-sidebar">
           ...
           <div style={{backgroundColor:"#ddd"}}  className="portlet light bordered">
                                                
                                                <div className="row list-separated profile-stat">
                                                    
                                                    <div style={{margin:"auto auto "}} className="col-md-4 col-sm-4 col-xs-6">
                                                        <div style={{fontSize:"25px"}}   className="uppercase profile-stat-title"> {count} </div>
                                                        <div style={{fontSize:"15px",width:"200px",marginRight:"40pxx"}}className="uppercase profile-stat-text"> Number of Patients in charge </div>
                                                    </div>
