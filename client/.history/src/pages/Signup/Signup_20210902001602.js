            ...
            <div className="card card-4">
                ...
                <h2 classNameName="headtitle" > Sign Up </h2>
                    ...
                    <form  onSubmit={(e)=>submit(e)}>
                        <div className="row row-space espace">
                            <div className="col-2">
                        ...
                        <div className="p-t-15">
                            <button style={{backgroundColor:"rgba(136, 172, 226, 0.8) !important "}} className="btn btn--radius-2 btn--blue" type="submit">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
