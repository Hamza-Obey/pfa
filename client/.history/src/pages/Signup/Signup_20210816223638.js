                                ...
                                <div class="input-group">
                                    ...
                                    <div class="p-t-10">
                                        <label value="male" class="radio-container m-r-45"> Male
                                            <input  value='male' required type="radio" onChange={(e)=>setGender(e.target.value)} value={gender}  checked="checked" name="gender"/>
                                            <span class="checkmark"></span>
                                        </label>
                                        <label value ="female" class="radio-container">Female
                                            <input value="female" type="radio" name="gender"  onChange={(e)=>setGender(e.target.value)} value={gender}
