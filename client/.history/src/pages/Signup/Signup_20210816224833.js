                    ...
                    <form  onSubmit={(e)=>submit(e)}>
                        ...
                        <div class="input-group">
                            ...
                            <div style={{marginLeft:"20px",marginTop:"1.8px"}} class="rs-select2 js-select-simple select--no-search">
                                <select style={{backgroundColor:"e0dbdb"}} name="occupation" 
                                
                                >
                                    <option value="-" onChange={(e)=>setOccupation(e.target.value)} required disabled="disabled" selected="selected">Choose</option>
                                    <option value="Nurse" onChange={(e)=>setOccupation(e.target.value)} required > Nurse </option>
                                    <option value="Internal Nurse" onChange={(e)=>setOccupation(e.target.value)} required>Internal Doctor</option>
                                    <option value="Intern" onChange={(e)=>setOccupation(e.target.value)} required>Intern</option>
                                    <option value="Doctor" onChange={(e)=>setOccupation(e.target.value)} required>Doctor </option>
