    ...
    <div className="Signupcover">
        ...
        <div className="wrapper wrapper--w680">
            <div className="card card-4">
                ...
                <h2 classNameName="headtitle" > Sign Up </h2>

                    
                    <form  onSubmit={(e)=>submit(e)}>
                        <div className="row1 row-space">
                            <div className="col-2">
                                <div className="input-group">
                                    <label style={{width:"230px"}} className="label">first name</label>
                                    <input style={{width:"230px"}} className="input--style-4" type="text" name="first_name" value={first_name}
