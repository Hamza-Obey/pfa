                                ...
                                <div class="input-group">
                                    ...
                                    <div class="p-t-10">
                                        <label value="male" class="radio-container m-r-45"> Male
                                            <input   required type="radio" value={gender} onChange={(e)=>setGender(e.target.value)} checked="checked" name="gender"/>
                                            <span onChange={(e)=>setGender(e.target.value)} class="checkmark"></span>
                                        </label>
                                        <label value ="female" class="radio-container">Female
                                            ...
                                            />
                                            <span value={gender} onChange={(e)=>setGender(e.target.value)} class="checkmark"></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
