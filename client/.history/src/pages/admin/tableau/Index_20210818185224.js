...
function Index() {
  ...
  useEffect(  () =>  { 
    ...
    const response = await axios.get("http://localhost:3002/auth/Signup")
    .then(res =>
      { console.log(data1)
       setData1(res.data) })
  ...
  const columns = React.useMemo(() => [
    {
      ...
      imgAccessor: 'https://images.unsplash.com/photo-1532417344469-368f9ae6d187?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=256&h=256&q=60 ',
    },
    {
      Header: "email",
      accessor: 'email',
