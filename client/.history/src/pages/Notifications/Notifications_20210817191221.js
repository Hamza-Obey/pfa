...
function Messages() {
  return (
    <div>
      <main role="main" class="container bootdey.com" style={{marginTop:"200px",marginLeft:"100px",height:"100vh"}}>
  <div style={{backgroundColor:"#aaaaaa",width:"400px"}} class="d-flex align-items-center p-3 my-3 text-white-50 bg-blue rounded box-shadow">
  ...
  <div class="my-3 p-3 bg-white rounded box-shadow">
    <h6 class="border-bottom border-gray pb-2 mb-0">Recents </h6>
    <div class="media text-muted pt-3">
      ...
      <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
        ...
        Donec id elit non mi porta gravida aeget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.
      </p>
    </div>
    <div class="media text-muted pt-3">
