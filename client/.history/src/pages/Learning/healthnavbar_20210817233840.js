  ...
  return (
    <div >
        ...
        <Toolbar position="static" className="navbar1">
          ...
          <i onClick={Logout} style={{marginLeft:"5cm",fontWeight:"-moz-initial",cursor:"pointer",float:"right",fontSize:"20px"}}  class="fa fa-sign-out" aria-hidden="true"> Sign out </i>
        </Toolbar>
