          ...
          <nav class="navbar nav1 navbar-expand-lg navbar-light ">
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="dropdown-item" href="#">Clinical Care Guidance</a>
                    <a class="dropdown-item" href="#">EPREVENT AND CONTROL COVID-19</a>
                    <a class="dropdown-item" href="#">FACILITY OPERATIONS</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="dropdown-item" href="#">Effectiveness</a>
