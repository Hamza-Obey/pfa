...
function Aboutcovid19() {
  return (
    ...
    <div className="container ">
        ...
        <div style={{marginTop:"70px"}} className="covid-left">
      ...
      <section className="covid-description">
        ...
        <div  className="covid-right sticky">
            ...
            <iframe style={{marginTop:"25cm"}} width="450px" height="349" src="http://www.youtube.com/embed/5DGwOJXSxqg;mute=0" frameborder="0" allow="autoplay" ></iframe>
        </div>
    </div>
    </section>
