  ...
  return (
    <div className="container-covid">
      ...
      <section className="covid-description">
          ...
          <p className="description2">COVID-19 is rapidly spreading across the globe and all providers must be prepared to recognize, stabilize and treat patients with novel coronavirus infection.  
