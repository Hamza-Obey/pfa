      ...
      <main >
        ...
        <div className={classes.heroContent} id="News">
          <Container maxWidth="sm" >
            <Typography style={{fontFamily:"serif"}}component="h1" variant="h2" align="center" color="textPrimary" gutterBottom>
              NEWS
            </Typography>
            ...
            {cards.map((card) => (
              ...
              <Grid  item key={card.id} xs={12} sm={6} md={4}>
                <Card className={classes.card}>
                  ...
                  <CardActions>
                    <Button href={card.Link} target="_"  size="small" color="primary" style={{fontWeight:"bold"}}> 
