    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar>
          ...
          <Button style={{fontSize:"50px"}} onClick={Logout} style={{height:"50px",width:"auto",marginLeft:"35cm",}}>
             
            <i style={{marginLeft:"10px",fontWeight:"-moz-initial"}}  class="fa fa-sign-out" aria-hidden="true"> </i>
      ...
      >
        ...
        <List style={{marginTop:"50px"}}>
            ...
            <Link className="link" to="HEALTHCARE"> <ListItem button  style={{color:"white",marginBottom:"20px"}}>
              <ListItemIcon style={{color:"white"}}> <i class='fas fa-book-reader' style={'font-size:36px'}></i> </ListItemIcon>
