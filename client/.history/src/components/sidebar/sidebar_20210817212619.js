    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar>
          ...
          <Button style={{fontSize:"50px"}} onClick={Logout} style={{height:"40",width:"auto",marginLeft:"",}}>
             <span style={{fontSize}}> Sign out </span>
            <i style={{marginLeft:"20px"}}  class="fa fa-sign-out" aria-hidden="true"> </i>
