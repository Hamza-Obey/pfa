    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar>
          ...
          >
            <MenuIcon />
                ...
                <ul class="navbar22  mr-auto">
                  ...
                  <li class="nav2">
                    <Link class="nav2-link" to=""> NEWS </Link>
                  </li>
                  <li class="nav2">
                  <Link class="nav2-link" to="">STATISTICS </Link>
                  </li>
                  <li class="nav2">
                  <Link class="nav2-link" to=""> BLOG  </Link>
                  </li>
                  <li class="nav2 ">
                    <Link class="nav2-link " to=""> CONTACT US </Link>
                  </li>
          ...
          <Button style={{height:"50px",width:"50px",marginLeft:"300px",alignContent:"center"}}>
