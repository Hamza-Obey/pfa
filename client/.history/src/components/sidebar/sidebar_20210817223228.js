      ...
      >
        <Toolbar>
          ...
          >
            ...
            <i onClick={Logout} style={{marginLeft:"35cm",fontWeight:"-moz-initial",cursor:"pointer",float:"right",fontSize:"35px"}}  class="fa fa-sign-out" aria-hidden="true"> Sign out </i>
