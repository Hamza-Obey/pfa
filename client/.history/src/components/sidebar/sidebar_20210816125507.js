    ...
    <div className={classes.root}>
      ...
      >
        ...
        <List style={{marginTop:"50px"}}>
            ...
            <Link className="link" to="admin" style={{marginTop:"50px"}}> <ListItem button  style={{color:"white"}}>
              <ListItemIcon style={{color:"white"}}> <PeopleAltIcon /> </ListItemIcon>
              <ListItemText primary="PERSONAL" /> 
            </ListItem>
            </Link>
            <Link className="link" to="Patients"> <ListItem button  style={{color:"white"}}>
              <ListItemIcon style={{color:"white"}}> <SupervisedUserCircleIcon /> </ListItemIcon>
              <ListItemText primary="PATIENTS" /> 
            </ListItem>
            </Link>
            <Link className="link"  to="Article"> <ListItem button  style={{color:"white"}}>
              <ListItemIcon style={{color:"white"}}> <DescriptionIcon /> </ListItemIcon>
              <ListItemText primary="ARTICLE" /> 
            </ListItem>
            </Link>
            <Link className="link" to="message"> <ListItem button  style={{color:"white"}}>
